    ...
    <div className="error-container">
      ...
      <div className="instructions">
        <h2>
          ...
          Please check if Message board backend service is running in <a target="_blank" href="http://localhost:4000/healthcheck" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">http://localhost:4000</a>.
        </h2>
